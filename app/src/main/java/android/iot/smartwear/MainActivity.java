...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displaySelectedFragment(R.id.nav_item_register);
    }
    ...
    private void displaySelectedFragment(int selectedFrameId) {
        ...
        switch (selectedFrameId) {
            case R.id.nav_item_register:
                ...
                break;
            case R.id.nav_item_monitor:
                selectedFragment = new MonitorFragment();
                break;
            case R.id.nav_item_vitals:
                selectedFragment = new VitalsFragment();
                break;
            case R.id.nav_item_recommend:
